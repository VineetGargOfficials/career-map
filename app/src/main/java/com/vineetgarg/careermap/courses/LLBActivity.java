...
import com.vineetgarg.careermap.roadmap.LLBRoadmapActivity;
...
public class LLBActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_llbactivity);
        ...
        roadmapBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(LLBActivity.this, LLBRoadmapActivity.class));
            }
        });
